...
- [Execution
  Modes](https://thisisamirv.github.io/lowess-project/r/articles/adapters.md):
...
- [Weight Functions
  (Kernels)](https://thisisamirv.github.io/lowess-project/r/articles/kernels.md):
...
- [Custom
  Weights](https://thisisamirv.github.io/lowess-project/r/articles/custom-weights.md):
...
- [GPU
  Backend](https://thisisamirv.github.io/lowess-project/r/articles/gpu-backend.md):

### Use Cases

- [Use Case: Genomic Data
  Smoothing](https://thisisamirv.github.io/lowess-project/r/articles/use-case-genomics.md):
- [Use Case: Time Series
  Analysis](https://thisisamirv.github.io/lowess-project/r/articles/use-case-time-series.md):
- [Use Case: Real-Time
