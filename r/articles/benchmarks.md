...
fractions, around n ≥ 100K–250K. See
[benchmarks/README.md](https://github.com/thisisamirv/lowess-project/blob/main/benchmarks/README.md#gpu-benchmarks)
for the full sweep and transfer-overhead breakdown.

See the [benchmarks
README](https://github.com/thisisamirv/lowess-project/blob/main/benchmarks/README.md)
for full sweep details and transfer-overhead breakdown.
