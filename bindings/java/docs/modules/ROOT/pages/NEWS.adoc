...
* Vendored the https://github.com/jothepro/doxygen-awesome-css[doxygen-awesome-css] theme (v2.4.2) for a modern, sidebar-only cpp Doxygen site with automatic dark mode.
