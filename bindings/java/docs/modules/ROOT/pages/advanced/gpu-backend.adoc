...
Download and install a prebuilt GPU-enabled `fastlowess_java` native library for this platform from the matching https://github.com/thisisamirv/lowess-project/releases[GitHub Release] (built by `.github/workflows/release-gpu.yml` for Linux/macOS/Windows x86_64 and macOS arm64):
