...
@testset "fastlowess Julia Bindings" begin
	...
	@testset "StreamingLowess" begin
		...
		@testset "return_se and confidence/prediction intervals" begin
			...
			@test r1.confidence_lower !== nothing
			@test r1.confidence_upper !== nothing
			@test r1.prediction_lower !== nothing
			@test r1.prediction_upper !== nothing
			@test r2.standard_errors !== nothing
		end
	end
	...
	@testset "OnlineLowess" begin
		...
		@testset "return_se and confidence/prediction intervals" begin
			...
			@test last_result.standard_error !== nothing
			@test last_result.confidence_lower !== nothing
			@test last_result.confidence_upper !== nothing
			@test last_result.prediction_lower !== nothing
			@test last_result.prediction_upper !== nothing
		end
	end
