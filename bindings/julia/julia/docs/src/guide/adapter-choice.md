...
println("Smoothed y[0]: ", result.y[1])
```

---

!!! warning "Always call finalize()"
    Always call `finalize(model)` after processing all chunks to retrieve buffered overlap data.
