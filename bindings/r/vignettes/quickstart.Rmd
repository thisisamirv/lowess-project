...
Smooth a noisy sine wave. `fraction = 0.3` and `iterations = 3` are good starting values for most signals.
...
Set `confidence_intervals` and/or `prediction_intervals` to a coverage level (0–1).
