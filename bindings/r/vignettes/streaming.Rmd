...
Processes data in fixed-size chunks with configurable overlap. Results for each
chunk are returned after calling `process_chunk()`. Call `finalize()` after the
last chunk to flush remaining buffered points.
