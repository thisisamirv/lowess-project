...
#'
#' @param object A \code{Lowess} object, fitted (via \code{\link{fit}}) with
#'   \code{retain_model = TRUE} passed to \code{\link{Lowess}}.
#' @param new_x Numeric vector of out-of-sample query points.
...
#'   \code{NULL} (default) disables it.
#' @param return_derivative Logical; include the local fit's derivative
#'   (slope) in the output. Default: \code{FALSE}.
...
#'   in a query's local window before \code{predict} errors, catching
