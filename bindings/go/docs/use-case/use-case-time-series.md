...
```output
residuals[0]: -0.1582436164551493
```
...
```output
95% PI: [0.15311435602040718, 0.2957788276788153]
```
...
fraction=0.2: y[0] = 0.22444659184961124
fraction=0.5: y[0] = 0.3343703604179156
```
