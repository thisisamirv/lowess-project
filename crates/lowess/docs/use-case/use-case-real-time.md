...
- [Execution Modes](crate::doc::guide::adapter_choice) — Detailed mode comparison
- [Merge Strategies](crate::doc::advanced::merge) — Chunk reconciliation in depth
- [Scaling Methods](crate::doc::weighting::scaling) — Robustness scale estimation
- [Time Series](crate::doc::use_case::time_series) — General time series analysis
