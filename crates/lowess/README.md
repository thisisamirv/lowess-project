...
<p align="center">
  ...
  <a href="https://github.com/thisisamirv/lowess-project/actions/workflows/ci-rust.yml"><img src="https://github.com/thisisamirv/lowess-project/actions/workflows/ci-rust.yml/badge.svg" alt="CI"></a>
</p>
...
> Currently available for R, Python, Rust, Julia, Node.js, WebAssembly, and C++. See the [Installation Guide](https://docs.rs/lowess) for detailed installation instructions.
>
> ### 📚 [View the full documentation](https://docs.rs/lowess)

### GPU Backend

GPU acceleration (`wgpu`: Vulkan/Metal/DX12) is also supported for high-throughput batch smoothing. See the [GPU Backend guide](https://docs.rs/lowess) for details.
...
Read more about how LOWESS works in the [Concepts](https://docs.rs/lowess/latest/lowess/doc/concepts/index.html).
...
For more details on the performance comparison, see the [Benchmarks](https://docs.rs/lowess) page.
