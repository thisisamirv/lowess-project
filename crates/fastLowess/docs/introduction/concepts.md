...
![LOWESS fits local weighted regressions at each point, using a focused local window around each evaluation point](https://raw.githubusercontent.com/thisisamirv/lowess-project/main/crates/fastLowess/assets/diagrams/lowess_concept.svg)
...
![Small fraction vs large fraction — bandwidth controls how closely the fit follows local structure](https://raw.githubusercontent.com/thisisamirv/lowess-project/main/crates/fastLowess/assets/diagrams/fraction_comparison.svg)
...
![Non-robust LOWESS (iterations=0) vs robust LOWESS — outlier influence is suppressed through iterative reweighting](https://raw.githubusercontent.com/thisisamirv/lowess-project/main/crates/fastLowess/assets/diagrams/robust_iter_comparison.svg)
...
![Confidence intervals (narrow, mean curve uncertainty) vs Prediction intervals (wide, new-point uncertainty)](https://raw.githubusercontent.com/thisisamirv/lowess-project/main/crates/fastLowess/assets/diagrams/intervals_comparison.svg)
...
- [Quick Start](crate::doc::introduction::quickstart) — See it in action
- [API Reference](crate::doc::api) — All configuration options
- [Boundary Handling](crate::doc::advanced::boundary) — Edge bias reduction strategies
